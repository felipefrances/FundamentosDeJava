//Faça um programa que receba um URL e, a partir desta URL, mostre qual o IP equivalente.
//        Para isso, a interface deve possuir os seguintes elementos:
//        (a) JButton
//        (b) JTextField
//        (c) JLabel
...
import java . net . UnknownHostException ;
        ...
        public class Exercicio03 extends JFrame {
            ...
            JTextField URL ;
            JButton CONVERTER ;
            public Exercicio03(String title ) {
                super ( title );
        ...
        public static void main ( String [] args ) {
            JFrame . setDefaultLookAndFeelDecorated ( true );
            Exercicio03 urlconverter = new Exercicio03("URL Converter ");
